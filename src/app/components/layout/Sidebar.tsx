    ...
    <aside className="fixed left-0 top-0 z-40 h-screen w-64 glass-panel border-y-0 border-l-0 border-r border-[rgba(255,255,255,0.05)] bg-[rgba(10,15,28,0.5)]">
      <div className="flex h-full flex-col px-4 py-8">
            ...
            <NavLink
              ...
              className={({ isActive }) =>
                cn(
                  ...
                  isActive
                    ? "bg-[rgba(255,255,255,0.05)] text-[#F4F5F8] border-l-[3px] border-[#74ee15] rounded-l-none pl-[13px]" // adjust padding to account for 3px border
        ...
        <div className="mt-auto">
          <NavLink
            to="/"
            className="flex items-center gap-3 rounded-lg px-4 py-3 text-sm font-medium text-[#8B949E] transition-colors hover:bg-[rgba(255,255,255,0.02)] hover:text-white"
          >
