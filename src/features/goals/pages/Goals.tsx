...
import { formatBRL } from '@/shared/lib/api';
...
function NewGoalModal({ onClose, onSave }: { onClose: () => void; onSave: (g: Goal) => void }) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      <div className="relative w-full max-w-lg rounded-3xl bg-[#0a0a0a] border border-white/[0.1] p-8">
        <button
          onClick={onClose}
        ...
        <div className="space-y-4">
          <div className="flex gap-3">
            ...
            <input
              ...
              placeholder={type === 'savings' ? 'Ex: Viagem pra praia' : 'Ex: Delivery'}
          ...
          <div className="flex gap-3">
            ...
            <input
              ...
              className="w-36 bg-white/[0.03] border border-white/[0.08] rounded-xl px-4 py-3 text-sm text-white placeholder-white/25 focus:outline-none focus:border-white/20 transition-colors"
            />
          </div>
          ...
          {type === 'spending' && (
            <input
              ...
              className="w-full bg-white/[0.03] border border-white/[0.08] rounded-xl px-4 py-3 text-sm text-white placeholder-white/25 focus:outline-none focus:border-white/20 transition-colors"
            />
          )}
        </div>
